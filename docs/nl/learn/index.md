...
- [The Year in Ethereum](https://medium.com/@jjmstark/the-year-in-ethereum-87a17d6f8276) *Jan 16, 2019 - Josh Stark, Evan Van Ness en Daniel Zakrisson*
...
- [EthHub](https://docs.ethhub.io) *Uitgebreide knowledge base voor alles over Ethereum*
- [District0x](https://education.district0x.io/general-topics/understanding-ethereum/) *Een educatieve bron over Ethereum, gericht op beginners*
- [Ethereum.wiki](https://ethereum.wiki) *Een door de community samengestelde wiki over de technologie van Ethereum*
- [Kauri](https://kauri.io) *Technische artikelen en tutorials voor Ethereum en gerelateerde projecten*
- [Ethereum Foundation YouTube](https://www.youtube.com/channel/UCNOfzGXD_C9YMYmnefmPH0g) *Video's and presentaties over Ethereum*
- [Week in Ethereum News](https://weekinethereumnews.com/) *Een wekelijkse nieuwsbrief over belangrijke ontwikkelingen in het ecosysteem*
...
- [What is Ether?](https://docs.ethhub.io/ethereum-basics/what-is-ether/) *Frequent bijgewerkt - EthHub*
...
- [What does it mean to mine Ethereum?](https://docs.ethhub.io/using-ethereum/mining/) *Frequent bijgewerkt - Ethhub*
...
- [The Case for Ethereum Scalability](https://medium.com/connext/the-case-for-ethereum-scalability-d2a8035f880f) *Jan 18, 2019 - Hunter Hillman, Steven McKie en Eric Olszewski*
...
- [State Channels](https://docs.ethhub.io/ethereum-roadmap/layer-2-scaling/state-channels/) *Frequent bijgewerkt - EthHub*
...
- [ETH 2.0 Roadmap and Phases](https://docs.ethhub.io/ethereum-roadmap/ethereum-2.0/eth-2.0-phases/) *Frequent bijgewerkt - EthHub*
...
- [Proof of Stake](https://docs.ethhub.io/ethereum-roadmap/ethereum-2.0/proof-of-stake/) *Frequent bijgewerkt - EthHub*
...
- [Ethereum’s roadmap isn’t ambitious enough](https://decryptmedia.com/6136/vulcanize-rick-dudley-ethereum-roadmap-makerdao-polkadot) *March 27, 2019 - Interview met Rick Dudley*
