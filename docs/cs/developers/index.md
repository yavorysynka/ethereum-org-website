...
- [Dokumentace](https://github.com/trufflesuite/truffle)
...
- [Dokumentace](https://getwaffle.io/)
...
- [Seznam nástrojů pro vývojáře pro Ethereum - frameworky](https://buidler.dev)
...
- [Ukázky kódu](https://forum.openzeppelin.com/c/sdk)
...
- [Seznam nástrojů pro vývojáře pro Ethereum - IDE](https://eth-brownie.readthedocs.io/en/latest/)
- [GitHub](https://github.com/iamdefinitelyahuman/brownie)

**web3j -** **_A Java/Android/Kotlin/Scala integration library for Ethereum._**

- [Github](https://web3j.io)
- [Dokumentace](https://github.com/web3j/web3j)
...
- [Dokumentace](https://npmjs.org/package/oneclick)
...
- [Dokumentace](https://superblocks.com/ethereum-studio)
...
- [List of EIPs](http://nethermind.io/)
- [EIP github repo](https://github.com/NethermindEth/nethermind)
- [EIP discussion board](https://gitter.im/nethermindeth/nethermind)

### Running your own node {#running-your-own-node}

**Ethnode -** **_Run an Ethereum node (Geth or Parity) for local development._**

- [List of ERCs](https://github.com/vrde/ethnode)
