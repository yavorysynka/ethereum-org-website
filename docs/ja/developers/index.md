...
- [ドキュメント](https://github.com/trufflesuite/truffle)
...
- [イーサリアム開発者ツールリスト #Frameworks](https://buidler.dev)
...
- [Azure Blockchain Workbench プラグイン](https://github.com/OpenZeppelin/openzeppelin-sdk)
- [サンプルコード](https://forum.openzeppelin.com/c/sdk)
...
- [ドキュメント](https://npmjs.org/package/oneclick)
...
- [ドキュメント](https://superblocks.com/ethereum-studio)
- [GitHub](https://github.com/SuperblocksHQ/ethereum-studio)

**Visual Studio Code -** **_Professional cross-platform IDE with official Ethereum support._**

- [イーサリアム開発者ツールリスト #Frontend-Ethereum-APIs](https://code.visualstudio.com/)
...
- [イーサリアム開発者ツールリスト #Security-Tools](https://0x.org/docs/web3-wrapper#introduction)
...
- [イーサリアム開発者ツールリスト #Testing-Tools](https://nodesmith.io/network/ethereum/)
...
- [イーサリアム開発者ツールリスト #Ethereum-clients](https://github.com/trailofbits/manticore)
...
- [イーサリアム開発者ツールリスト #Patterns—best-practices](https://github.com/dapphub/dapptools/tree/master/src/hevm)
...
- [EIPリスト](http://nethermind.io/)
- [EIP GitHubレポジトリ](https://github.com/NethermindEth/nethermind)
- [EIPディスカッションボード](https://gitter.im/nethermindeth/nethermind)

### Running your own node {#running-your-own-node}

**Ethnode -** **_Run an Ethereum node (Geth or Parity) for local development._**

- [ERCリスト](https://github.com/vrde/ethnode)
