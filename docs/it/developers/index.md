...
- [Documentazione](https://github.com/trufflesuite/truffle)
...
- [Documentazione](https://getwaffle.io/)
...
- [Elenco degli strumenti di sviluppo per Ethereum #Frameworks](https://buidler.dev)
...
- [Plugin Azure Blockchain Workbench](https://github.com/OpenZeppelin/openzeppelin-sdk)
- [Esempi di codice](https://forum.openzeppelin.com/c/sdk)
...
- [Elenco degli strumenti di sviluppo per Ethereum #IDEs](https://eth-brownie.readthedocs.io/en/latest/)
- [GitHub](https://github.com/iamdefinitelyahuman/brownie)

**web3j -** **_A Java/Android/Kotlin/Scala integration library for Ethereum._**

- [GitHub](https://web3j.io)
- [Documentazione](https://github.com/web3j/web3j)
...
- [Documentazione](https://npmjs.org/package/oneclick)
...
- [Documentazione](https://superblocks.com/ethereum-studio)
- [GitHub](https://github.com/SuperblocksHQ/ethereum-studio)

**Visual Studio Code -** **_Professional cross-platform IDE with official Ethereum support._**

- [Elenco di strumenti di sviluppo per Ethereum #Frontend-Ethereum-APIs](https://code.visualstudio.com/)
...
- [Elenco degli strumenti di sviluppo per Ethereum #Security-Tools](https://0x.org/docs/web3-wrapper#introduction)
...
- [Elenco degli strumenti di sviluppo per Ethereum #Testing-Tools](https://nodesmith.io/network/ethereum/)
...
- [Elenco degli strumenti di sviluppo per Ethereum #Ethereum-clients](https://github.com/trailofbits/manticore)
...
- [Registro SWC](https://github.com/ConsenSys/ethereum-developer-tools-list#security-tools)
...
- [Elenco degli strumenti di sviluppo per Ethereum #Patterns—best-practices](https://github.com/dapphub/dapptools/tree/master/src/hevm)
...
- [Lista delle EIP](http://nethermind.io/)
- [Repository GitHub delle EIP](https://github.com/NethermindEth/nethermind)
- [Forum di discussione per le EIP](https://gitter.im/nethermindeth/nethermind)

### Running your own node {#running-your-own-node}

**Ethnode -** **_Run an Ethereum node (Geth or Parity) for local development._**

- [Elenco delle ERC](https://github.com/vrde/ethnode)
