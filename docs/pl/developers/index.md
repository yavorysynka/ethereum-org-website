...
- [Dokumentacja](https://github.com/trufflesuite/truffle)
...
- [Przykłady kodu](https://forum.openzeppelin.com/c/sdk)
...
- [Dokumentacja](https://github.com/web3j/web3j)
...
- [Dokumentacja](https://npmjs.org/package/oneclick)
...
- [Dokumentacja](https://superblocks.com/ethereum-studio)
...
- [Lista EIP](http://nethermind.io/)
- [Repozytorium EIP na GitHub](https://github.com/NethermindEth/nethermind)
- [Forum dyskusyjne EIP](https://gitter.im/nethermindeth/nethermind)

### Running your own node {#running-your-own-node}

**Ethnode -** **_Run an Ethereum node (Geth or Parity) for local development._**

- [Lista ERC](https://github.com/vrde/ethnode)
