...
- [Ethereum Developer Portal - Everything you need to get started building on Ethereum](https://ethereum.consensys.net/ethereum-dev-portal) *oft aktualisiert – ConsenSys*
...
- [Full Stack Dapp Tutorial Series ](https://kauri.io/collection/5b8e401ee727370001c942e3) *oft aktualisiert – Joshua Cassidy*
...
- [Dokumentation](https://github.com/trufflesuite/truffle)
...
- [Dokumentation](https://getwaffle.io/)
...
- [Liste der Entwicklertools für Ethereum #Frameworks](https://buidler.dev)
...
- [Plugin für Azure Blockchain Workbench](https://github.com/OpenZeppelin/openzeppelin-sdk)
- [Code-Beispiele](https://forum.openzeppelin.com/c/sdk)
...
- [Liste der Entwicklertools für Ethereum #IDEs](https://eth-brownie.readthedocs.io/en/latest/)
- [GitHub](https://github.com/iamdefinitelyahuman/brownie)

**web3j -** **_A Java/Android/Kotlin/Scala integration library for Ethereum._**

- [GitHub](https://web3j.io)
- [Dokumentation](https://github.com/web3j/web3j)
...
- [Dokumentation](https://npmjs.org/package/oneclick)
...
- [Dokumentation](https://superblocks.com/ethereum-studio)
- [GitHub](https://github.com/SuperblocksHQ/ethereum-studio)

**Visual Studio Code -** **_Professional cross-platform IDE with official Ethereum support._**

- [Liste der Entwicklertools für Ethereum #Frontend-Ethereum-APIs](https://code.visualstudio.com/)
...
- [Liste der Entwicklertools für Ethereum #Security-Tools](https://0x.org/docs/web3-wrapper#introduction)
...
- [Liste der Entwicklertools für Ethereum #Testing-Tools](https://nodesmith.io/network/ethereum/)
...
- [Liste der Entwicklertools für Ethereum #Ethereum-clients](https://github.com/trailofbits/manticore)
...
- [Liste der Entwicklertools für Ethereum #Patterns—best-practices](https://github.com/dapphub/dapptools/tree/master/src/hevm)
...
- [Liste der EIPs](http://nethermind.io/)
- [EIP-github-Repo](https://github.com/NethermindEth/nethermind)
- [EIP-Diskussionsforum](https://gitter.im/nethermindeth/nethermind)

### Running your own node {#running-your-own-node}

**Ethnode -** **_Run an Ethereum node (Geth or Parity) for local development._**

- [Liste der EIPs](https://github.com/vrde/ethnode)
